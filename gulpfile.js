...
gulp.task('default', gulp.series(gulp.parallel('js', 'css', 'plugins', 'fonts'), 'test'))

gulp.task('build', gulp.parallel('js', 'css', 'plugins', 'fonts'))
...
gulp.task('serve', () => {
    ...
    gulp.watch(['fonts/cera-round/*'], gulp.series('fonts', 'reload'))
