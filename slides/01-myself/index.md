...
- Занимаюсь Backend и Frontend 🥤<!-- .element: class="fragment" data-fragment-index="1" -->
- В данный момент работаю над Embed 🛠<!-- .element: class="fragment" data-fragment-index="2" -->
